        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Pokemon>(entity =>
            {
                entity.HasKey(e => e.Nombre)
                    .HasName("PK__pokemon__72AFBCC7078A2598");
                ...
                entity.HasOne(d => d.RegionNavigation)
                    ...
                    .HasConstraintName("FK__pokemon__region__05D8E0BE");

                entity.HasOne(d => d.TipoNavigation)
                    .WithMany(p => p.PokemonTipoNavigation)
                    .HasForeignKey(d => d.Tipo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__pokemon__tipo__03F0984C");

                entity.HasOne(d => d.Tipo2Navigation)
                    .WithMany(p => p.PokemonTipo2Navigation)
                    .HasForeignKey(d => d.Tipo2)
                    .HasConstraintName("FK__pokemon__tipo2__04E4BC85");
            });
